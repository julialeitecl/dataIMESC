# -*- coding: utf-8 -*-
"""ATUALIZA_DATAIMESC.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/188i_-hWpzhHR97OobvVh_qCd3lDIizGB
...
SERIES = "1"#@param {type:"string"}
SERIES=[int(x) for x in SERIES.split(",")]
TODOS_OS_ANOS = True#@param {type:"boolean"}
ANO_2025 = False#@param {type:"boolean"}
ANO_2024 = False#@param {type:"boolean"}
ANO_2023 = False#@param {type:"boolean"}
ANO_2022 = False#@param {type:"boolean"}
ANO_2021 = False#@param {type:"boolean"}
ANO_2020 = False#@param {type:"boolean"}
ANO_2019 = False#@param {type:"boolean"}
ANO_2018 = False#@param {type:"boolean"}
ANO_2017 = False#@param {type:"boolean"}
ANO_2016 = False#@param {type:"boolean"}
ANO_2015 = False#@param {type:"boolean"}
ANO_2014 = False#@param {type:"boolean"}
ANO_2013 = False#@param {type:"boolean"}
ANO_2012 = False#@param {type:"boolean"}
ANO_2011 = False#@param {type:"boolean"}
ANO_2010 = False#@param {type:"boolean"}
ANO_2009 = False#@param {type:"boolean"}
ANO_2008 = False#@param {type:"boolean"}
ANO_2007 = False#@param {type:"boolean"}
ANO_2006 = False#@param {type:"boolean"}
ANO_2005 = False#@param {type:"boolean"}
ANO_2004 = False#@param {type:"boolean"}
ANO_2003 = False#@param {type:"boolean"}
ANO_2002 = False#@param {type:"boolean"}
ANO_2001 = False#@param {type:"boolean"}
ANO_2000 = False#@param {type:"boolean"}
TODOS_OS_ANOS='-10' if TODOS_OS_ANOS else False
ANO_2025 = '2025' if ANO_2025 else False
ANO_2024 = '2025' if ANO_2024 else False
ANO_2023 = '2023' if ANO_2023 else False
ANO_2022 = '2022' if ANO_2022 else False
ANO_2021 = '2021' if ANO_2021 else False
ANO_2020 = '2020' if ANO_2020 else False
ANO_2019 = '2019' if ANO_2019 else False
ANO_2018 = '2018' if ANO_2018 else False
ANO_2017 = '2017' if ANO_2017 else False
ANO_2016 = '2016' if ANO_2016 else False
ANO_2015 = '2015' if ANO_2015 else False
ANO_2014 = '2014' if ANO_2014 else False
ANO_2013 = '2013' if ANO_2013 else False
ANO_2012 = '2012' if ANO_2012 else False
ANO_2011 = '2011' if ANO_2011 else False
ANO_2010 = '2010' if ANO_2010 else False
ANO_2009 = '2009' if ANO_2009 else False
ANO_2008 = '2008' if ANO_2008 else False
ANO_2007 = '2007' if ANO_2007 else False
ANO_2006 = '2006' if ANO_2006 else False
ANO_2005 = '2005' if ANO_2005 else False
ANO_2004 = '2004' if ANO_2004 else False
ANO_2003 = '2003' if ANO_2003 else False
ANO_2002 = '2002' if ANO_2002 else False
ANO_2001 = '2001' if ANO_2001 else False
ANO_2000 = '2000' if ANO_2000 else False
ANOS=[ANO_2000,ANO_2001,ANO_2002,ANO_2003,ANO_2004,ANO_2005,ANO_2006,ANO_2007,ANO_2008 ,ANO_2009 ,ANO_2010 ,ANO_2011 ,ANO_2012 ,ANO_2013 ,ANO_2014 ,ANO_2015,ANO_2016,ANO_2017,ANO_2018 ,ANO_2019 ,ANO_2020, ANO_2021,ANO_2022,ANO_2023,ANO_2024,ANO_2025,TODOS_OS_ANOS ]
ANO=[]
for i in ANOS:
  if(i):
    ANO.append(i)
...
for i in SERIES:
  try:
    ...
    print("Houve algum erro na execução")
